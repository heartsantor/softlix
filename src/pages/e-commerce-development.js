  ...
  return (
    <>
          ...
          <div className="flex flex-wrap ">
              ...
              <div className="md:py-0 py-5 flex h-full w-full flex-col relative">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-900 text-lg title-font font-medium">
                    Maximize Your Sales & Order Value
                  </h2>
                </div>
                <div className="flex-grow">
                  <p className="leading-relaxed text-base">
                    with a shop that attracts customers & floods them with buyer
                    confidence
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 md:w-1/4 w-full">
              <div className="md:py-0 py-5 flex h-full w-full flex-col relative before:content-[''] before:absolute md:before:h-full before:h-[2px] md:before:w-[2px] before:w-full before:bg-black/20 md:before:top-0 before:-top-5 md:before:-left-6 before:left-auto">
                ...
                <div className="flex-grow">
                  <p className="leading-relaxed text-base">
                    with automated email flows for up-sells, cart reminders, &
                    more
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 md:w-1/4 w-full">
              <div className="md:py-0 py-5 flex h-full w-full flex-col relative before:content-[''] before:absolute md:before:h-full before:h-[2px] md:before:w-[2px] before:w-full before:bg-black/20 md:before:top-0 before:-top-5 md:before:-left-6 before:left-auto">
                <div className="flex items-center mb-3">
                  ...
                  <h2 className="text-gray-900 text-lg title-font font-medium">
                    Sell All Over the Globe
                  </h2>
                </div>
                <div className="flex-grow">
                  <p className="leading-relaxed text-base">
                    by taking your products online within hours of using our app
            ...
            <div className="p-4 md:w-1/4 w-full">
              <div className="md:py-0 py-5 flex h-full w-full flex-col relative before:content-[''] before:absolute md:before:h-full before:h-[2px] md:before:w-[2px] before:w-full before:bg-black/20 md:before:top-0 before:-top-5 md:before:-left-6 before:left-auto">
                ...
                <div className="flex-grow">
                  <p className="leading-relaxed text-base">
                    Design Which will surely attract the Customers
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-1/2 bg-[#f8f9fb] max-h-[450px]">
            <div className="md:py-24 py-16 md:px-16 px-6">
              ...
              <p className="leading-relaxed text-lg mt-3">
                ...
                Magento, PHP, or Python, the SOFTLIX app makes it simple, quick,
                & more effective - Helping you to launch your online business
                and sell more products in less time (and with less effort!)
              </p>
              <p className="leading-relaxed text-lg mt-3">
          ...
          <div className="grid md:gap-16 gap-8 row-gap-0 md:grid-cols-4">
            <div className="relative text-center  group">
              ...
              <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                We'll design, build, & develop a stunning website to launch your
                business & start selling worldwide
              </p>
            ...
            <div className="relative text-center group">
              ...
              <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                Building & running a high-converting marketing campaign is
                simple with SOFTLIX Inc's built-in advertising toolbox
              </p>
              <div className="top-0 right-0 flex items-center justify-center h-24 lg:-mr-8 lg:absolute">
                <svg
                  className="w-8 text-gray-700 transform rotate-90 lg:rotate-0"
            ...
            <div className="relative text-center group">
              ...
              <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                Open the floodgates to worldwide customers with multiple payment
                gateways you and your customers can trust
              </p>
              <div className="top-0 right-0 flex items-center justify-center h-24 lg:-mr-8 lg:absolute">
                <svg
                  className="w-8 text-gray-700 transform rotate-90 lg:rotate-0"
            ...
            <div className="relative text-center group">
              ...
              <h6 className="mb-2 text-lg font-bold">Shipping Made Easy</h6>
              <p className="max-w-md mb-3 text-sm text-gray-900 sm:mx-auto">
                Shipping your products is a breeze with tap-and-go solutions for
          ...
          <div className="xl:px-20 px-8 py-20 2xl:mx-auto 2xl:container relative ">
            ...
            >
              <div className="mb-10 text-center ">
                ...
                <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
                  Hundreds of users now selling online using SOFTLIX Inc
                </h2>
                <p className="text-base text-gray-700 md:text-lg">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      ...
                      <p className="font-medium text-gray-800">
                        Perfect for a Beginner or Dedicated Brand
                      </p>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-2">
                    ...
                    <li className="flex items-center">
                      ...
                      <p className="font-medium text-gray-800">
                        Android and IOS App to Supercharge & Scale your Business
                      </p>
                    </li>
                  </ul>
                </div>
            ...
            <div className="flex flex-col justify-between p-5 bg-white rounded-lg shadow-2xl">
              <div className="mb-6">
                <div className="flex items-center justify-between pb-6 mb-6 border-b">
                  <div>
                    <p className="text-sm font-bold tracking-wider uppercase">
                      Multi vendor Package
                    </p>
                    <p className="text-5xl font-extrabold">$750</p>
                  </div>
                ...
                <div>
                  <p className="mb-2 font-bold tracking-wide">
                    Build multiple high-profit online stores
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      <div className="mr-2">
                      ...
                      <p className="font-medium text-gray-800">
                        Ideal for Seasoned Professionals or Owners of Multiple
                        Businesses
                      </p>
                    </li>
                    <li className="flex items-center">
                      ...
                      <p className="font-medium text-gray-800">
                        Web Version of App for Each of Your Businesses
                      </p>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-2">
                      ...
                      <p className="font-medium text-gray-800">
                        SOFTLIX App to Supercharge & Scale your Business
                      </p>
                    </li>
                  </ul>
                </div>
      ...
      <section className="bg-[#020637] py-2">
        <div className="container mx-auto">
          <p className="leading-relaxed text-base text-white text-center">
            © 2022 SOFTLIX Ltd. All rights reserved
          </p>
        </div>
      </section>
    </>
