          ...
          <Box display={'flex'} sx={{ flexDirection: 'column', flex: '1' }}>
            ...
            >
              <Button
                component="a"
                target="blank"
                href="https://facebook.com/SOFTLIX  Incofficial/"
                size="medium"
                sx={{
                  padding: 0,
              ...
              <Button
                component="a"
                target="blank"
                href="https://www.linkedin.com/showcase/SOFTLIX  Incglobal/"
                size="medium"
                sx={{
                  padding: 0,
                  background: 'none!important',
              ...
              <Button
                component="a"
                target="blank"
                href="https://twitter.com/SOFTLIX  Incglobal"
                size="medium"
                sx={{
                  padding: 0,
                  background: 'none!important',
              ...
              <Button
                component="a"
                target="blank"
                href="https://www.instagram.com/SOFTLIX  Incglobal/"
                size="medium"
                sx={{
                  padding: 0,
                  background: 'none!important',
              ...
              <Button
                component="a"
                target="blank"
                href="https://medium.com/@SOFTLIX  Inc"
                size="medium"
                sx={{
                  padding: 0,
                  background: 'none!important',
